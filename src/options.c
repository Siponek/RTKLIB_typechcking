...
opt_t sysopts[]={
    ...
    {"pos1-posopt1",    3,           (void *)&prcopt_.posopt[0],  SWTOPT }, // SAT PCV SET
    ...
    {"gter-newIntParameter",  0,     (void *)&prcopt_.gterInt,     "8)" },
    //{"gter-newStrParameter",  2,    (void*)&gteropt_.gterString,   ":)"  },
